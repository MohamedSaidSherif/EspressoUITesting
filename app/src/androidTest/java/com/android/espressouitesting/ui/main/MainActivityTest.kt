...
class MainActivityTest {
    ...
    @Test
    fun testVisibility_titleAndNextButton() {
        val activityScenario = ActivityScenario.launch(MainActivity::class.java)
    ...
    @Test
    fun clickNextButton_navigateToSecondaryActivity() {
        val activityScenario = ActivityScenario.launch(MainActivity::class.java)
    ...
    @Test
    fun clickNextButton_navigateToSecondaryActivity_clickBackButton_NavigateToMainActivity() {
        val activityScenario = ActivityScenario.launch(MainActivity::class.java)
